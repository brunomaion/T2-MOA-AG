...
def atualizar():
    ...
    print("Tamanho solução inicial:", len(nova_solucao), "Custo:", fn.funcao_objetiva_por_calculo(nova_solucao))
    fn.desenhar(nova_solucao, canvas=viewport, max_view_x=500, max_view_y=500)

#solucao = [[0, 0], [0, 100], [100, 100], [100, 0]]
solucao = [[0, 0], [100, 100], [0, 100], [100, 0]]

ch150 = fn.criar_grafo_ch150()
solucao = ch150.vertices
print("Tamanho solução inicial:", len(solucao), "Custo:", fn.funcao_objetiva_por_calculo(solucao))
